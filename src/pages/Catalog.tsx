...
export default function Catalog() {
  ...
  return (
    <div className="pt-20 md:pt-32 min-h-screen bg-white">
      {/* Page header */}
      <div className="bg-luxury-charcoal py-12 md:py-16 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="font-sans font-light text-xs tracking-[0.35em] uppercase text-gold mb-3">Telas Web 2026</p>
          <h1 className="font-serif text-3xl md:text-4xl text-white">{pageTitle}</h1>
          <p className="font-sans font-light text-sm text-white/50 mt-3">
